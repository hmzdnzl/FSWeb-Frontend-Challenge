  ...
  return (
    ...
    >
      ...
      <div className="flex w-full max-w-[1010px] justify-end pr-8">
        <button onClick={handleReturnHome} className="border mt-6 rounded-md p-1 bg-[#4731D3] border-[#4731D3] text-white" >{language==="en" ? "Return to Home" : "Anasayfaya Dön"}</button>
      </div>
